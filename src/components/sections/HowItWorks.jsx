...
export const HowItWorks = ({ onStart }) => {
  const steps = [
    { number: 1, title: 'Select Track', description: 'Choose Fiber or Coaxial analysis based on your map type.', icon: Navigation },
    { number: 2, title: 'Upload Maps', description: 'Upload Before, After & Reference maps for comparison.', icon: UploadCloud },
    { number: 3, title: 'Set Options', description: 'Configure DPI, Sensitivity & Collision parameters.', icon: Settings },
    { number: 4, title: 'Run AI', description: 'Start the Autonomous Analysis Engine with one click.', icon: Play },
  ];
