    ...
    <div className="relative bg-slate-950 overflow-x-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-6xl px-6">
          ...
          <SplitText
            tag="h1"
            text="AI-Powered Network Topology Analysis Tool"
            className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight text-white leading-[1.1] mb-12 drop-shadow-[0_0_40px_rgba(0,0,0,0.8)] [text-shadow:0_4px_30px_rgba(0,0,0,0.6)] font-sans px-4"
            delay={40}
            duration={1.2}
            ease="power3.out"
          ...
          >
            <button
              ...
              className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-white text-black font-semibold tracking-wide hover:bg-gray-100 transition-colors shadow-lg"
            >
              Get Started
            </button>
            <button
              onClick={scrollToLearnMore}
              className="w-full sm:w-auto px-8 py-3.5 rounded-full border border-white/10 bg-[#16161a]/80 text-gray-300 font-semibold tracking-wide hover:bg-white/10 transition-colors backdrop-blur-sm shadow-lg"
            >
              Learn More
            </button>
          </motion.div>
      ...
      >
        <div className="max-w-6xl mx-auto space-y-32">
          ...
          <div className="text-center pt-10">
             <button 
               onClick={() => navigate('/dashboard')}
               className="group relative px-12 py-5 bg-white text-black font-black rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95"
             >
